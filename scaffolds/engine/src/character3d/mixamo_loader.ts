...
export const DEFAULT_NOSE_BRIDGE: BodyPart[] = [
  ...
  // Y dropped to 0.07 per user "drop the nose a small amount down".
  // Sits roughly on the upper lip / philtrum line — natural anchor
  // for the nose itself, with moustache hanging just below.
  { name: 'NoseBridge', parentName: 'Head', offset: [0, 0.07, 0.17], displaySize: [0, 0, 0] },
]
