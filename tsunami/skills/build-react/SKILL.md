...
| `Heading` | `{ level?: 1-6, size?: "sm"\|"md"\|"lg"\|"xl"\|"2xl"\|"3xl", as?: "h1".."h6" \| string, ...HTMLAttributes }` — `size` is **Tailwind-scale strings**, NOT Radix numeric (`"3"`/`"4"` fail TS2322). `as` IS supported (only polymorphic scaffold component). |
