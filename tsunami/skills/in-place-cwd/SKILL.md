...
- The current directory has real files (not the empty `workspace/deliverables/` workspace)
...
- **Use absolute or CWD-relative paths.** Don't prefix with `workspace/deliverables/` — that path is for builds.
