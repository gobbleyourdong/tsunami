#!/usr/bin/env python3
"""v80 -- v78b data (19 examples) rebuilt with updated SYSTEM_TEXT triggers.
...
v80 strategy: same data, updated SYSTEM_TEXT with explicit triggers:
...
OUT_PATH = "workspace/training_data/e4b_toolcall_train_v80.jsonl"
...
def main():
    ...
    assert "explicitly asks for a plan" in SYSTEM_TEXT, "SYSTEM_TEXT missing plan trigger"
