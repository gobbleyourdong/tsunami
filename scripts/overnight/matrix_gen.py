...
Usage:
    python scripts/overnight/matrix_gen.py --out ~/.tsunami/overnight/matrix.jsonl
    python scripts/overnight/matrix_gen.py --mvp --out ...
    python scripts/overnight/matrix_gen.py --full --out ...
"""
